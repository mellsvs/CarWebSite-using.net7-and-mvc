...
namespace WebDers.Migrations
{
    ...
    [Migration("20230606122450_addcarblog")]
    partial class addcarblog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDers.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("WebDers.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("WebDers.Models.CarBlog", b =>
                {
            ...
            modelBuilder.Entity("WebDers.Models.Hakkimizda", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDers.Models.Iletisim", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDers.Models.Siparis", b =>
                {
            ...
            modelBuilder.Entity("WebDers.Models.User", b =>
                {
                    b.Property<int>("UserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDers.Models.Yorumlar", b =>
                {
            ...
            modelBuilder.Entity("WebDers.Models.Siparis", b =>
                {
                    b.HasOne("WebDers.Models.Brand", "Brand")
                        .WithMany("Sipariss")
                        .HasForeignKey("BrandID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebDers.Models.User", "User")
                        .WithMany("Sipariss")
            ...
            modelBuilder.Entity("WebDers.Models.Yorumlar", b =>
                {
                    b.HasOne("WebDers.Models.CarBlog", "CarBlog")
                        .WithMany("Yorumlars")
